...
if __name__ == '__main__':
    ...
    for i in range(args.runs):
        ...
        data = data.to(device)
        # print(coarsen_features.dtype, coarsen_edge.dtype)

        # import pdb; pdb.set_trace()
        # if coarsen_features.dtype == torch.double:
        #     coarsen_features = coarsen_features.to(torch.double)
        #     print(coarsen_features.dtype)
